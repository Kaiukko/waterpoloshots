...
L'interfaccia segue il design system **"Phoenix Sport Pro"**: sfondo quasi nero, rosso
primario (#e60000) e oro secondario (#ffb800) personalizzabili da Admin → Impostazioni,
tipografia "Anybody" in maiuscolo con titoli in corsivo, forme squadrate (angoli vivi anche
sulle card, arrotondati solo per badge/avatar/pillole), icone Material Symbols Outlined,
barre di accento colorate e bordi inferiori a contrasto sulle card interattive.
