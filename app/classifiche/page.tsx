            ...
            <tbody>
              {standings.map((r, i) => (
                <tr key={r.team.id} className="border-b border-line/60 last:border-0">
                  ...
                  <td className="px-2 py-2.5 text-center text-[#B8B8BC]">{r.won}</td>
                  <td className="px-2 py-2.5 text-center text-[#B8B8BC]">{r.drawn}</td>
                  <td className="px-2 py-2.5 text-center text-[#B8B8BC]">{r.lost}</td>
              ...
              {standings.length === 0 && (
                <tr>
                  <td colSpan={8} className="px-3 py-6 text-center text-[#8A8A8E]">
