...
export default function AdminSettings({ settings, reload }: { settings: Settings | null; reload: () => void }) {
  ...
  if (!form) return <p className="text-sm text-outline">Caricamento impostazioni…</p>;
  ...
  return (
    <div className="space-y-5">
      <h2 className="font-display text-lg font-black italic">Personalizzazione &amp; Branding</h2>

      <div>
        <label className="mb-1.5 block text-xs font-semibold text-on-surface-variant">Titolo torneo</label>
        <input
      ...
      <div>
        <label className="mb-1.5 block text-xs font-semibold text-on-surface-variant">Sottotitolo</label>
        <input
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          <label className="mb-1.5 block text-xs font-semibold text-on-surface-variant">Colore primario</label>
        ...
        <div>
          <label className="mb-1.5 block text-xs font-semibold text-on-surface-variant">Colore secondario</label>
          <div className="flex items-center gap-2">
            <input
              type="color"
